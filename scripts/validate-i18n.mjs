...
const failures = [];
for (const rel of ["src/i18n/request.ts", "src/i18n/routing.ts", "messages/id.json", "messages/en.json", "src/components/i18n/locale-switcher.tsx"]) {
...
for (const ns of ["BlogArticle", "ProductDetail", "LocaleSwitcher"]) {
