...
export async function getPublicSiteConfig() {
  ...
  return {
    ...
    siteLogo: stringOf(settings, "site_logo", "/brand/madina-logo.png"),
    siteIcon: stringOf(settings, "site_icon", "/icons/madina-512.png"),
    ...
    socialInstagram: stringOf(settings, "social_instagram"),
    socialFacebook: stringOf(settings, "social_facebook"),
    socialTiktok: stringOf(settings, "social_tiktok"),
    socialYoutube: stringOf(settings, "social_youtube"),
    socialLinkedin: stringOf(settings, "social_linkedin"),
