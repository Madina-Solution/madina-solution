...
export async function CTA() {
  ...
  return (
    <section className="relative overflow-hidden bg-[radial-gradient(circle_at_top_right,rgba(255,180,117,.32),transparent_34%),linear-gradient(135deg,#E85D04,#A94000_52%,#171411)] py-20 lg:py-28">
      ...
      <div className="relative mx-auto max-w-7xl px-4 lg:px-6">
        <div className="text-center">
          ...
          <div className="mt-12 grid grid-cols-2 gap-3 text-white/70 sm:grid-cols-4">
            <div className="rounded-2xl border border-white/10 bg-white/5 p-4 backdrop-blur-md"><span className="text-2xl font-bold text-white">{stats.products}+</span><p>Produk</p></div>
            <div className="rounded-2xl border border-white/10 bg-white/5 p-4 backdrop-blur-md"><span className="text-2xl font-bold text-white">{stats.services}+</span><p>Layanan</p></div>
            <div className="rounded-2xl border border-white/10 bg-white/5 p-4 backdrop-blur-md"><span className="text-2xl font-bold text-white">{stats.testimonials}+</span><p>Testimoni</p></div>
            <div className="rounded-2xl border border-white/10 bg-white/5 p-4 backdrop-blur-md"><span className="text-2xl font-bold text-white">{stats.categories}</span><p>Kategori</p></div>
          </div>
        </div>
      </div>
    </section>
