      ...
      {showForm && (
        <Card><CardContent className="p-6">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div className="sm:col-span-2"><RichTextEditor label="Deskripsi produk" value={form.description} onChange={(description) => setForm(p => ({ ...p, description }))} minHeight={360} /></div>
