...
type Article = { id: string; title: string; slug: string; excerpt: string | null; category: string | null; isPublished: boolean | null; publishedAt: string | null; createdAt: string };
...
export default function AdminArticlesPage() {
  ...
  const [form, setForm] = React.useState({ title: "", slug: "", excerpt: "", content: "", category: "", isPublished: false });
  ...
  const resetForm = () => { setShowForm(false); setEditId(null); setForm({ title: "", slug: "", excerpt: "", content: "", category: "", isPublished: false }); };
  ...
  const startEdit = (a: Article) => { setForm({ title: a.title, slug: a.slug, excerpt: a.excerpt || "", content: "", category: a.category || "", isPublished: !!a.isPublished }); setEditId(a.id); setShowForm(true); };
