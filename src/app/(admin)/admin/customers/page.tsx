            ...
            <tr key={c.id} className="border-b border-dark-50 last:border-0 hover:bg-dark-50/50">
              <td className="px-5 py-3.5">
                <div className="flex items-center gap-3">
                  <div className="relative h-9 w-9 overflow-hidden rounded-full bg-dark-50">{c.avatar ? <SiteImage src={c.avatar} alt={c.name} width={36} height={36} className="h-9 w-9 rounded-full object-cover" /> : <MediaPlaceholder label="Avatar" className="h-full w-full" />}</div>
