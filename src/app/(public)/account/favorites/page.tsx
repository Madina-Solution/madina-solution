...
type Favorite = { id: string; productId: string | null; productName: string | null; productSlug: string | null; productPrice: string | null; productUnit: string | null };
          ...
          <Card key={fav.id}>
            <CardContent className="flex items-center justify-between gap-4 p-5">
              <div className="flex items-center gap-4">
                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-dark-50 text-lg font-bold text-dark-300">{(fav.productName || "?").charAt(0)}</div>
                <div>
